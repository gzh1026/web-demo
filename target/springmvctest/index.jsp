...
<html>
<body>
<form action="/test/login" method="post" class="login">
    <h1 class="login-title">登录页面</h1><br />
    <input type="text" name="email" class="login-input" placeholder="请输入邮箱或者电话号码" autofocus /><br/>
    <input type="password" name="password" class="login-input" placeholder="请输入密码" /> <br/>
    <input type="submit" value="登陆" class="login-submit" /><br/>
    </p><input type="submit" formaction="/test/tiaozhuan" value="注册"><br/>
</form>
